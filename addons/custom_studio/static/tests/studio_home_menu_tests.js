odoo.define("custom_studio.studio_home_menu_tests", function (require) {
    "use strict";

    const StudioHomeMenu = require("custom_studio.StudioHomeMenu");
    ...
    QUnit.module("custom_studio", {
        ...
        QUnit.test("simple rendering", async function (assert) {
            ...
            assert.containsOnce(secondApp, '.o_custom_studio_edit_icon i');

            // New app button
            assert.containsOnce(parent.el, 'div.o_apps > a.o_app.o_custom_studio_new_app', 'should contain a "New App icon"');
            const newApp = parent.el.querySelector('a.o_app.o_custom_studio_new_app');
            assert.strictEqual(newApp.querySelector('div.o_app_icon').style.backgroundImage, 'url("/custom_studio/static/src/img/default_icon_app.png")',
                "Image source URL should end with '/custom_studio/static/src/img/default_icon_app.png'");
        ...
        QUnit.test("Click on edit icon button", async function (assert) {
            ...
            const firstEditIconButton = parent.el.querySelector('.o_custom_studio_edit_icon i');
            ...
            assert.containsOnce(dialog, '.modal-content.o_custom_studio_edit_menu_icon_modal .o_custom_studio_icon_creator');
