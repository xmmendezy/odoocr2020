odoo.define('custom_studio.testUtils', function (require) {
"use strict";
...
var ReportEditorManager = require('custom_studio.ReportEditorManager');
...
async function createReportEditor(params) {
        ...
        start: function () {
            ...
            this._super.apply(this, arguments).then(function () {
                var $studio = $.parseHTML(
                    "<div class='o_custom_studio_client_action'>" +
                            "<div class='o_custom_studio_editor_manager o_custom_studio_report_editor_manager'/>" +
                        "</div>" +
                    "</div>");
    ...
    return parent.appendTo(selector).then(function () {
        ...
        return editor.appendTo(parent.$('.o_custom_studio_editor_manager')).then(function () {
            return editor;
        });
    });
}
...
async function createReportEditorManager(params) {
    ...
    dom.append(parent.$('.o_custom_studio_client_action'), fragment, {
...
async function createSidebar(params) {
    ...
    return loadAssetLib(parent).then(function () {
        ...
        return sidebar.appendTo(fragment).then(function () {
            sidebar.$el.appendTo(parent.$('.o_custom_studio_editor_manager'));
            return sidebar;
        });
    });
}
