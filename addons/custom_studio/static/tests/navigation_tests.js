odoo.define('custom_studio.navigation_tests', function (require) {
"use strict";
...
QUnit.module('Studio Navigation', {
    ...
    QUnit.test('open Studio with act_window', async function (assert) {
        ...
        const { widget: actionManager } = await start({
            ...
            mockRPC: function (route) {
                assert.step(route);
                if (route === '/custom_studio/get_studio_view_arch') {
        ...
        await actionManager.doAction('action_custom_studio_action_editor', {
        ...
        rpcs = [
            '/custom_studio/activity_allowed',
            '/custom_studio/get_studio_view_arch',
        ...
        assert.containsOnce(actionManager, '.o_custom_studio_client_action .o_custom_studio_kanban_view_editor',
        ...
        assert.containsNone(actionManager, '.o_custom_studio_client_action',
    ...
    QUnit.test('open Studio with act_window and viewType', async function (assert) {
        ...
        const { widget: actionManager } = await start({
            ...
            data: this.data,
            mockRPC: function (route) {
                if (route === '/custom_studio/chatter_allowed') {
        ...
        assert.containsOnce(actionManager, '.o_custom_studio_client_action .o_custom_studio_form_view_editor',
    ...
    QUnit.test('navigation in Studio with act_window', async function (assert) {
        ...
        assert.containsOnce(actionManager, '.o_custom_studio_client_action .o_custom_studio_list_view_editor',
            "the list view should be opened");
    ...
    QUnit.test('open Studio with non editable view', async function (assert) {
        ...
        assert.containsOnce(actionManager, '.o_custom_studio_action_editor',
    ...
    QUnit.test('open Studio with editable form view and check context propagation', async function (assert) {
        ...
        await testUtils.dom.click(actionManager.$('.o_custom_studio_form_view_editor .o_field_one2many'));
        await testUtils.dom.click(actionManager.$('.o_custom_studio_form_view_editor .o_field_one2many .o_custom_studio_editX2Many[data-type="form"]'));
