odoo.define('custom_studio.NewModeltests', function (require) {
"use strict";

const NewModel = require('custom_studio.NewModel');
    ...
    QUnit.test('Add New Model', async function (assert) {
        ...
        testUtils.mock.addMockEnvironment(newModel, {
            mockRPC: function (route, args) {
                if (route === "/custom_studio/create_new_menu") {
        ...
        assert.containsNone($, '.o_custom_studio_new_model_modal',
        ...
        assert.containsOnce($, '.o_custom_studio_new_model_modal',
        ...
        const $configuratorModal = $('.o_custom_studio_model_configurator');
        ...
        await testUtils.dom.click($configuratorModal.find('.o_custom_studio_model_configurator_next'));
