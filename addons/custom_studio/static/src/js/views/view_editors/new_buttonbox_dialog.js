odoo.define('custom_studio.NewButtonBoxDialog', function (require) {
"use strict";
...
var NewButtonBoxDialog = Dialog.extend(StandaloneFieldManagerMixin, {
    template: 'custom_studio.NewButtonBoxDialog',
    events: {
        'click .o_custom_studio_icon_selector': '_on_IconSelector',
    },
    /**
     * @override
     */
