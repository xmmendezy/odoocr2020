odoo.define('custom_studio.ActionEditorAction', function (require) {
"use strict";
...
var ActionEditor = require('custom_studio.ActionEditor');
var bus = require('custom_studio.bus');
var NewViewDialog = require('custom_studio.NewViewDialog');
var MapViewDialog = require('custom_studio.MapViewDialog');
var ViewEditorManager = require('custom_studio.ViewEditorManager');
...
var ActionEditorAction = AbstractAction.extend({
    ...
    start: function () {
        var self = this;
        var def;
        this.$el.addClass('o_custom_studio_client_action');
    ...
    _addViewType: function (action, view_type, args) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            self._rpc({
                route: '/custom_studio/add_view_type',
                params: {
    ...
    _editAction: function (action, args) {
        ...
        core.bus.trigger('clear_cache');
        return this._rpc({
            route: '/custom_studio/edit_action',
            params: {
                action_type: action.type,
                action_id: action.id,
                args: args,
    ...
    _getStudioViewArch: function (model, view_type, view_id) {
        ...
        core.bus.trigger('clear_cache');
        return this._rpc({
            route: '/custom_studio/get_studio_view_arch',
            params: {
                model: model,
                view_type: view_type,
                view_id: view_id,
    ...
    _isActivityAllowed: function () {
        ...
        return this._rpc({
            route: '/custom_studio/activity_allowed',
            params: {
                model: modelName,
            }
    ...
    _isChatterAllowed: function () {
        ...
        return this._rpc({
            route: '/custom_studio/chatter_allowed',
            params: {
                model: res_model,
            }
    ...
    _writeViewMode: function (view_mode, initial_view_mode) {
        ...
        return def.then(function (result) {
            ...
            return self.do_action('action_custom_studio_action_editor', {
                action: result,
                noEdit: true,
            });
        });
    ...
    _onNewView: function (event) {
        ...
        def.then(function (result) {
            self.do_action('action_custom_studio_action_editor', {
                action: result,
                viewType: view_type,
            });
        });
...
core.action_registry.add('action_custom_studio_action_editor', ActionEditorAction);
