odoo.define('custom_studio.ActionEditor', function (require) {
"use strict";

var Widget = require('web.Widget');

var ActionEditorSidebar = require('custom_studio.ActionEditorSidebar');
var ActionEditorView = require('custom_studio.ActionEditorView');

var ActionEditor = Widget.extend({
    template: 'custom_studio.ActionEditor',
    custom_events: {
    ...
    start: function () {
        ...
        _.each(ordered_view_types, function (view_type) {
            ...
            if (category) {
                view.appendTo(
                    self.$('.o_custom_studio_view_category[name=' + category + ']')
                );
            }
        });
