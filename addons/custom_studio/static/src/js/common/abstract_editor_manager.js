odoo.define('custom_studio.AbstractEditorManager', function (require) {
"use strict";
...
var XMLEditor = require('custom_studio.XMLEditor');

var _lt = core._lt;
var _t = core._t;

var AbstractEditorManager = Widget.extend({
    className: 'o_custom_studio_editor_manager',
    custom_events: {
        ...
        return this._super.apply(this, arguments).then(function () {
            return self._instantiateEditor().then(function (editor) {
                ...
                var $editorFragment = $('<div>', {
                    class: 'o_custom_studio_view_renderer',
                });
                self.editor = editor;
    ...
    _updateSidebar: function (mode, params) {
        ...
        if  (this.sidebar.$el) {
            ...
            // TODO: scroll top is calculated to 'o_custom_studio_sidebar_content'
