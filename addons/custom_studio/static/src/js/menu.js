odoo.define('custom_studio.Menu', function (require) {
"use strict";
...
var NewModel = require('custom_studio.NewModel')
var SubMenu = require('custom_studio.SubMenu');
...
Menu.include({
    events: _.extend({}, Menu.prototype.events, {
        'click .o_custom_studio_change_background': '_onChangeBackground',
        'click .o_custom_studio_reset_default_background': '_onResetDefaultBackground',
        'click .o_custom_studio_export': '_onExport',
        'click .o_custom_studio_import': '_onImport',
    }),
    /**
     * @override
     */
    ...
    switchMode: function (mode) {
        ...
        if (mode) {
            ...
            if (mode === 'main') {
                ...
                // In home menu
                this.$home_studio_menu = $(qweb.render('custom_studio.HomeStudioMenu', {
                    widget: this,
                }));
            ...
            this.$leave_button = $('<div>')
                .addClass('o_custom_studio_leave')
                .append($('<a>', {
                    href: '#',
            ...
            // Notes link
            this.$notes = $('<div>')
                .addClass('o_custom_studio_notes')
                .append($('<a>', {
    ...
    _setBackgroundImage: function (attachment_id) {
        return this._rpc({
            route: '/custom_studio/set_background_image',
            params: {
    ...
    _onResetDefaultBackground: function () {
        ...
        Dialog.confirm(this, message, {
            confirm_callback: function () {
                framework.blockUI();
                self._rpc({
                    route: '/custom_studio/reset_background_image',
                    params: {
                        context: session.user_context,
                    },
                }).then(function () {
