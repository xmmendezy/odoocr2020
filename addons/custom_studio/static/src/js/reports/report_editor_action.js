odoo.define('custom_studio.ReportEditorAction', function (require) {
"use strict";
...
var ReportEditorAction = AbstractAction.extend({
    ...
    _editReport: function (values) {
        return this._rpc({
            route: '/custom_studio/edit_report',
            params: {
    ...
    _readPaperFormat: function () {
        var self = this;
        return this._rpc({
            route: '/custom_studio/read_paperformat',
            params: {
    ...
    _readWidgetsOptions: function () {
        var self = this;
        return this._rpc({
            route: '/custom_studio/get_widgets_available_options',
            params: {
                context: session.user_context,
            },
...
core.action_registry.add('custom_studio.action_edit_report', ReportEditorAction);
