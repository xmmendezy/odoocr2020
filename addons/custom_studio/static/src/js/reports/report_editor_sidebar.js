odoo.define('custom_studio.ReportEditorSidebar', function (require) {
"use strict";
...
var newComponentsRegistry = require('custom_studio.reportNewComponentsRegistry');
var studioUtils = require('custom_studio.utils');
...
var ReportEditorSidebar = Widget.extend(StandaloneFieldManagerMixin, {
    template: 'custom_studio.ReportEditorSidebar',
    events: {
        'change input': '_onChangeReport',
        'click .o_custom_studio_sidebar_header > div:not(.inactive)': '_onTab',
        'click .o_custom_studio_xml_editor': '_onXMLEditor',
        'click .o_custom_studio_parameters': '_onParameters',
        'click .o_custom_studio_remove': '_onRemove',
    },
    /**
     * @constructor
     * @param {Widget} parent
    ...
    _startModeNew: function () {
        var self = this;
        var defs = [];
        var $sidebarContent = this.$('.o_custom_studio_sidebar_content');
        ...
        _.each(newComponentsRegistry.map, function (components, title) {
            ...
            var $componentsContainer = $('<div>', {
                class: 'o_custom_studio_field_type_container',
            });
    ...
    _startModeProperties: function () {
        ...
        var $accordion = this.$('.o_custom_studio_sidebar_content .o_custom_studio_accordion');
        ...
        this.nodes.forEach(function (node) {
            var $accordionSection = $(qweb.render('custom_studio.AccordionSection', {
            ...
            componentsAppendedPromise = Promise.all(renderingProms).then(function () {
                ...
                var $removeButton = $(qweb.render('custom_studio.Sidebar.Remove'));
            ...
            $accordionSection
                ...
                .find('.collapse').on('show.bs.collapse hide.bs.collapse', function (ev) {
                    $(this).parent('.card').toggleClass('o_custom_studio_active', ev.type === 'show');
                });
        });
        ...
        $lastCard.addClass('o_custom_studio_active');
    ...
    _startModeReport: function () {
        ...
        defs.push(many2one.appendTo(this.$('.o_custom_studio_paperformat_id')));
