odoo.define('custom_studio.EditMenu', function (require) {
"use strict";

const CommonMenuDialog = require('custom_studio.CommonMenuDialog');
...
var MenuItem = Widget.extend({
    template: 'custom_studio.EditMenu.MenuItem',
    events: {
...
var EditMenuDialog = Dialog.extend({
    template: 'custom_studio.EditMenu.Dialog',
    ...
    init: function (parent, menu_data, current_primary_menu, scrollToBottom) {
        var options = {
            title: _t('Edit Menu'),
            size: 'medium',
            dialogClass: 'o_custom_studio_edit_menu_modal',
            buttons: [{
                text: _t("Confirm"),
                classes: 'btn-primary',
...
const NewMenuDialog = CommonMenuDialog.extend({
    template: 'custom_studio.EditMenu.Dialog.New',
    ...
    start: function () {
        ...
        this.opened().then(function () {
            self.$modal.addClass('o_custom_studio_add_menu_modal');
            // focus on input
    ...
    _doSave(menuName) {
        ...
        return this._rpc({
            route: '/custom_studio/create_new_menu',
            params: {
                menu_name: menuName,
                model_id: modelID,
