...
class ResConfigSettings(models.TransientModel):
    ...
    map_box_token = fields.Char(config_parameter='custom_web_map.token_map_box',string = 'Token Map Box', help='Necessary for some functionalities in the map view', copy=True, default='', store=True)
