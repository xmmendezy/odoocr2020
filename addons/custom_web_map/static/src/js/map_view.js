odoo.define('custom_web_map.MapView', function (require) {
"use strict";

const MapModel = require('custom_web_map.MapModel');
const MapController = require('custom_web_map.MapController');
const MapRenderer = require('custom_web_map.MapRenderer');
...
const MapView = AbstractView.extend({
    jsLibs: [
        '/custom_web_map/static/lib/leaflet/leaflet.js',
    ],
