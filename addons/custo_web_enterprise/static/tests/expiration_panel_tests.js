odoo.define("custo_web_enterprise.expiration_panel_tests", function (require) {
    "use strict";

    const ExpirationPanel = require("custo_web_enterprise.ExpirationPanel");
    ...
    QUnit.module("custo_web_enterprise", {}, function () {
