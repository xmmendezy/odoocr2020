odoo.define('custo_web_enterprise.mobile_menu_tests', function (require) {
"use strict";

var Menu = require('custo_web_enterprise.Menu');
var testUtils = require('web.test_utils');
var testUtilsEnterprise = require('custo_web_enterprise.test_utils');
var UserMenu = require('web.UserMenu');

QUnit.module('custo_web_enterprise mobile_menu_tests', {
    afterEach() {
