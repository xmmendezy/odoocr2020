 ...
 */
odoo.define('custo_web_enterprise.mobile_company_switcher_tests', function (require) {
    "use strict";

    const testUtils = require('web.test_utils');
    const { SwitchCompanyMenuMobile } = require('custo_web_enterprise.SwitchCompanyMenu');
