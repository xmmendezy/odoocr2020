odoo.define('custo_web_enterprise.ControlPanel', function (require) {
    "use strict";
     ...
     */
    ControlPanel.patch('custo_web_enterprise.ControlPanel', T => {
        ...
        ControlPanelPatchEnterprise.template = 'custo_web_enterprise.ControlPanel';
