odoo.define('custom_web_map.MapRenderer', function (require) {
    "use strict";
    ...
    class MapRenderer extends AbstractRendererOwl {
        ...
        async willStart() {
            ...
            [this._pinCircleSVG, this._pinNoCircleSVG] = await Promise.all([
                this.env.services.httpRequest('custom_web_map/static/img/pin-circle.svg', p, 'text'),
                this.env.services.httpRequest('custom_web_map/static/img/pin-no-circle.svg', p, 'text'),
            ]);
        ...
        _addMarkers() {
            ...
            for (const markerInfo of Object.values(markersInfo)) {
                ...
                const iconInfo = {
                    ...
                    html: this.env.qweb.renderToString('custom_web_map.marker', params),
                };
        ...
        _createMarkerPopup(markerInfo) {
            ...
            const popupHtml = this.env.qweb.renderToString('custom_web_map.markerPopup', {
                fields: popupFields,
    ...
    MapRenderer.template = 'custom_web_map.MapRenderer';
