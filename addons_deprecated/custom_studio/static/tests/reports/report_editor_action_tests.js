odoo.define('custom_studio.ReportEditorAction_tests', function (require) {
    "use strict";
    ...
    QUnit.module('Studio', {
        ...
        QUnit.test('use pager', async function (assert) {
            ...
            const actionManager = await createActionManager({
                ...
                async mockRPC(route) {
                    switch (route) {
                        case "/custom_studio/get_report_views":
                            return { report_html: reportHTML };
                        case "/custom_studio/get_widgets_available_options":
                        case "/custom_studio/read_paperformat":
                            return {};
                        default:
            ...
            await actionManager.doAction("custom_studio.action_edit_report", {
                report: {
