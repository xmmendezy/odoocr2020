odoo.define('custom_studio.ViewEditorSidebar', function (require) {
"use strict";
...
var view_components = require('custom_studio.view_components');
...
return Widget.extend(StandaloneFieldManagerMixin, {
    template: 'custom_studio.ViewEditorSidebar',
    events: {
        'click .o_custom_studio_new:not(.inactive)':            '_onTab',
        'click .o_custom_studio_view':                          '_onTab',
        'click .o_custom_studio_xml_editor':                    '_onXMLEditor',
        'click .o_display_view .o_custom_studio_parameters':    '_onViewParameters',
        'click .o_display_field .o_custom_studio_parameters':   '_onFieldParameters',
        'click .o_display_view .o_custom_studio_defaults':      '_onDefaultValues',
        'change #show_invisible':                            '_onShowInvisibleToggled',
        'click .o_custom_studio_remove':                        '_onElementRemoved',
        'click .o_custom_studio_restore':                       '_onRestoreDefaultView',
        'change .o_display_view input':                      '_onViewChanged',
        'change .o_display_view select':                     '_onViewChanged',
        'click .o_custom_studio_edit_selection_values':         '_onSelectionValues',
        ...
        'click .o_custom_studio_sidebar_approval .o_approval_archive':  '_onApprovalArchive',
        'change .o_custom_studio_sidebar_approval':                     '_onApprovalChange',
        'click .o_custom_studio_sidebar_approval .o_approval_domain':   '_onApprovalDomain',
        'click .o_custom_studio_sidebar_approval .o_approval_new':      '_onApprovalNewRule',
        ...
        'click .o_custom_studio_attrs':                         '_onDomainAttrs',
        'focus .o_display_filter input#domain':              '_onDomainEditor',
        'keyup .o_custom_studio_sidebar_search_input':          '_onSearchInputChange',
    },
    /**
     * @constructor
     * @param {Widget} parent
    ...
    */
    ...
    _render: function () {
        ...
        if (this.state.mode === 'new') {
            ...
            return Promise.all(this.defs).then(() => {
                delete(this.defs);
                this.$('.o_custom_studio_component').on("drag", _.throttle((event, ui) => {
    ...
    _renderComponentsSection: function () {
        ...
        $section.addClass('o_custom_studio_new_components');
        const $sidebarContent = this.$('.o_custom_studio_sidebar_content');
    ...
    _renderExistingFieldsSection: function () {
        const $existingFields = this.$('.o_custom_studio_existing_fields');
        ...
        const $sidebarContent = this.$('.o_custom_studio_sidebar_content');
        const $section = this._renderSection(formWidgets);
        $section.addClass('o_custom_studio_existing_fields');
        if ($existingFields.length) {
            ...
            const $sectionSearchDiv = core.qweb.render('custom_studio.ExistingFieldsInputSearch');
    ...
    _renderNewFieldsSection: function () {
        ...
        const $section = this._renderSection(formWidgets);
        $section.addClass('o_custom_studio_new_fields');
    ...
    _renderSection: function (form_widgets) {
        var self = this;
        var $components_container = $('<div>').addClass('o_custom_studio_field_type_container');
    ...
    _onSearchInputChange: function () {
        this._searchValue = this.$('.o_custom_studio_sidebar_search_input').val();
