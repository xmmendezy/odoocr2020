odoo.define('custom_studio.tour', function (require) {
"use strict";

var core = require('web.core');
var tour = require('web_tour.tour');

var utils = require('custom_studio.utils');

var _t = core._t;

tour.register('custom_studio_home_menu_background_tour', {
    url: "/web",
}, [{
    ...
    trigger: '.o_custom_studio_home_studio_menu a',
    content: _t('Click here.'),
    position: 'right',
}, {
    trigger: '.o_custom_studio_home_studio_menu .dropdown-menu .dropdown-item:eq(0)',
    content: _t('Change the <b>background</b>, make it yours.'),
    position: 'bottom',
}]);

tour.register('custom_studio_new_app_tour', {
    ...
    trigger: '.o_custom_studio_selectors .o_custom_studio_selector:eq(2)',
    ...
    trigger: '.o_custom_studio_form_view_editor td.o_td_label',
    ...
    extra_trigger: '.o_custom_studio_form_view_editor td.o_td_label:contains(My Field)',
    ...
    trigger: '.o_custom_studio_sidebar .o_custom_studio_field_type_container:eq(1) .o_custom_studio_field_selection',
    content: _t('Drag & drop <b>another field</b>. Let’s try with a <i>selection field</i>.'),
    position: 'bottom',
    run: 'drag_and_drop .o_custom_studio_form_view_editor .o_inner_group',
}, {
    trigger: '.o_custom_studio_field_dialog_form > .o_custom_studio_add_selection input',
    content: _t("Create your <b>selection values</b> (e.g.: Romance, Polar, Fantasy, etc.)"),
    position: 'top',
    run: 'text ' + utils.randomString(6),
}, {
    trigger: '.o_custom_studio_field_dialog_form > .o_custom_studio_add_selection .o_custom_studio_add_selection_value',
    auto: true,
}, {
    trigger: '.modal-footer > button:eq(0)',
    auto: true,
}, {
    trigger: '.o_custom_studio_sidebar_text',
    auto: true,
}, {
    trigger: '.o_custom_studio_form_view_editor .o_Chatter',
    ...
    trigger: '.o_custom_studio_sidebar .o_display_chatter input[name="email_alias"]',
