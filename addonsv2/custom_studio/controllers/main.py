...
from odoo.addons.custom_studio.controllers import export
...
class WebStudioController(http.Controller):
    ...
    @http.route('/custom_studio/chatter_allowed', type='json', auth='user')
    ...
    @http.route('/custom_studio/activity_allowed', type='json', auth='user')
    ...
    @http.route('/custom_studio/get_studio_action', type='json', auth='user')
    ...
    @http.route('/custom_studio/create_new_app', type='json', auth='user')
    ...
    @http.route('/custom_studio/create_new_menu', type='json', auth='user')
    ...
    @http.route('/custom_studio/edit_menu_icon', type='json', auth='user')
    ...
    @http.route('/custom_studio/set_background_image', type='json', auth='user')
    def set_background_image(self, attachment_id):
        attachment = request.env['ir.attachment'].browse(attachment_id)
        if attachment:
            request.env.company.background_image = attachment.datas

    @http.route('/custom_studio/reset_background_image', type='json', auth='user')
    ...
    @http.route('/custom_studio/add_view_type', type='json', auth='user')
    ...
    @http.route('/custom_studio/edit_action', type='json', auth='user')
    ...
    @http.route('/custom_studio/get_studio_view_arch', type='json', auth='user')
    ...
    @http.route('/custom_studio/restore_default_view', type='json', auth='user')
    ...
    @http.route('/custom_studio/edit_approval', type='json', auth='user')
    ...
    @http.route('/custom_studio/edit_view', type='json', auth='user')
    ...
    @http.route('/custom_studio/rename_field', type='json', auth='user')
    ...
    @http.route('/custom_studio/edit_field', type='json', auth='user')
...
Are you sure you want to remove the selection values of those records?""") % len(records)
    ...
    @http.route('/custom_studio/edit_view_arch', type='json', auth='user')
    ...
    @http.route('/custom_studio/export', type='http', auth='user')
    ...
    @http.route('/custom_studio/create_default_view', type='json', auth='user')
    ...
    @http.route('/custom_studio/get_email_alias', type='json', auth='user')
    ...
    @http.route('/custom_studio/set_email_alias', type='json', auth='user')
    ...
    @http.route('/custom_studio/get_default_value', type='json', auth='user')
    ...
    @http.route('/custom_studio/set_default_value', type='json', auth='user')
    ...
    @http.route('/custom_studio/create_inline_view', type='json', auth='user')
