...
from odoo.addons.custom_studio.controllers import main
from odoo.exceptions import ValidationError, UserError


class WebStudioReportController(main.WebStudioController):

    @http.route('/custom_studio/create_new_report', type='json', auth='user')
    ...
    @http.route('/custom_studio/print_report', type='json', auth='user')
    ...
    @http.route('/custom_studio/edit_report', type='json', auth='user')
    ...
    @http.route('/custom_studio/read_paperformat', type='json', auth='user')
    def read_paperformat(self, report_id):
        report = request.env['ir.actions.report'].browse(report_id)
        return report.get_paperformat().read()

    @http.route('/custom_studio/get_widgets_available_options', type='json', auth='user')
    ...
    @http.route('/custom_studio/get_report_views', type='json', auth='user')
    ...
    @http.route('/custom_studio/edit_report_view', type='json', auth='user')
    ...
    @http.route('/custom_studio/edit_report_view_arch', type='json', auth='user')
    ...
    @http.route('/custom_studio/edit_report/test_load_assets', type='json', auth='user')
